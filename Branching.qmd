...
5.  Switch back to the main branch. You should see that the Readme.md file is in the state it was before branching.
6.  Switch back to the Readme-edits branch.
