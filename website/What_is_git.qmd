...
Librarians of a libray want to publish a book on the proceedings of a community project. They decide to publish the book it as a web book via Github and Gitbook. They want to keep adding to the website, as the community project is an annual event.
